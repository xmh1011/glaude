...
### Phase 5: 终端 UI 架构层
> 📖 开始前读：`docs/plan.md` Phase 5 + `docs/reference/14-ui-state.md`
...
> 📖 开始前读：`docs/plan.md` Phase 10 + `docs/reference/12-startup-bootstrap.md` + `docs/reference/14-ui-state.md` + `docs/reference/15-services-api-layer.md`
